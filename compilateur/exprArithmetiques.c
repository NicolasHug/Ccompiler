...
int exprInfEgal (int op1, int op2) {
  ...
  fprintf_add(getNombreVariablesLocales() - 1, getNombreVariablesLocales() - 1, getNombreVariablesLocales() - 2); 
  return getNombreVariablesLocales() - 1;
}
...
int exprAdresse (char * op1) {
  ...
  ajouterSymbole(NULL,TEMP,1,0); 
  fprintf_addEBP(getNombreVariablesLocales() - 1, getNombreVariablesLocales() - 2);
  return getNombreVariablesLocales() - 1;
}
...
int exprCrochet (char * tab, int indice) {
  ...
  ajouterSymbole(NULL,TEMP,1,0); 
  fprintf_cpi (getNombreVariablesLocales() - 1, getNombreVariablesLocales() - 2); 
  return getNombreVariablesLocales() - 1;
}
